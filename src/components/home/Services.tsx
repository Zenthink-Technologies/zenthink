...
const Services = () => {
  return (
    <>
      <div id="services" className="w-full max-w-[1440px] mx-auto h-auto py-14">
        ...
        <div className="flex justify-between items-center space-x-6 px-28 pb-36">
          <div className="relative w-full grid grid-cols-3 items-center justify-center transition-all duration-500 ease-in-out">
            <div
              className="min-w-[390px] max-w-full h-[460px] rounded-lg bg-white/5"
              style={{
                boxShadow: `
  ...
  `,
          ...
          <div className="relative w-full flex items-center justify-center transition-all duration-500 ease-in-out">
            <div
              className="min-w-[390px] max-w-full h-[460px] rounded-lg flex justify-center items-center bg-white/5 overflow-hidden"
              style={{
                boxShadow: `
    inset 0 -5px 5px rgba(255, 255, 255, 0.01),
    inset 0 2px 1.5px rgba(255, 255, 255, 0.05)
  `,
          ...
          <div className="relative w-full flex items-center justify-center transition-all duration-500 ease-in-out">
            <div
              className="min-w-[390px] max-w-full h-[460px] rounded-lg flex justify-end items-center bg-white/5 overflow-hidden"
              style={{
                boxShadow: `
    inset 0 -5px 5px rgba(255, 255, 255, 0.01),
    inset 0 2px 1.5px rgba(255, 255, 255, 0.05)
