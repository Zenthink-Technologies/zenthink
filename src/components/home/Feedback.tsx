              ...
              {feedbacks.map((feedback) => (
                <Carousel.Slide key={feedback.id}>
                  <div className="relative mt-32 sm:mt-[100px] md:mt-[120px] lg:mt-[135px] mx-4 sm:mx-8 md:mx-12 lg:mx-20 rounded-lg h-[280px] sm:h-[250px] md:h-[300px] lg:h-[300px] flex flex-col lg:flex-row transform transition-all">
                    ...
                    {/* Content */}
                    <div className="lg:absolute overflow-hidden lg:pl-[300px] xl:pl-[350px] px-4 sm:px-6 lg:pr-[60px] xl:pr-[100px] w-full lg:w-[95%] h-full lg:h-[340px] bottom-0 right-0 bg-black/20 rounded-lg flex flex-col justify-center items-center">
                      {/* Gradient for mobile */}
